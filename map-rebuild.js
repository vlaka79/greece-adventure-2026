(function () {
  ...
  function inPhotoBounds(lat, lng) {
    return lat >= 34.5 && lat <= 38.9 && lng >= 22 && lng <= 27;
  }
  ...
  function renderPhotoPins() {
    ...
    var groups = groupPhotos(photoItems, greeceMap);
    groups.forEach(function (g, i) {
      ...
      marker.on("click", function (ev) {
        ...
        onPhotoClusterClick(greeceMap, g);
      });
  ...
  function rebuildGreece() {
    ...
    greeceMap.fitBounds([[35.18, 23.55], [35.58, 24.28]], { padding: [24, 24], animate: false });

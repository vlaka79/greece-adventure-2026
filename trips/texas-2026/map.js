(function () {
  ...
  var photoLayer = null;
  var tripMap = null;
  var PATH_URL = "/trips/texas-2026/path.json";
  var AIS_URL = null;
  var ALBUM_URL = "/trips/texas-2026/album.json";
  var DRIVES_URL = "/trips/texas-2026/drives.json";
  var MILES_URL = "/trips/texas-2026/miles.json";
  ...
  function inPhotoBounds(lat, lng) {
    return lat >= 29 && lat <= 49 && lng >= -112 && lng <= -94;
  }
